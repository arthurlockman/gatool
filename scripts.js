...
function initEnvironment() {
    ...
    localStorage.qualsList = '{"Schedule":[]}';
    localStorage.teamList = '{"Schedule":[]}';
    localStorage.clock = "ready";
    localStorage.matchHighScore = 0;
    localStorage.highScoreDetails = "{}";
...
function loadEventsList() {
    ...
    req.open('GET', apiURL + localStorage.currentYear + '/events');
...
function getHybridSchedule() {
    ...
    req.addEventListener('load', function () {
        ...
        if (data.Schedule.length === 0) {
            ...
            matchSchedule += '<thead class="thead-default"><tr><td class="col2"><b>Time</b></td><td  class="col2"><b>Description</b></td><td class="col1"><b>Match Number</b></td><td class="col1"><b>Score</b></td><td class="col1"><b>Red 1</b></td><td class="col1"><b>Red 2</b></td><td class="col1"><b>Red 3</b></td><td class="col1"><b>Blue 1</b></td><td class="col1"><b>Blue 2</b></td><td class="col1"><b>Blue 3</b></td></tr></thead><tbody>';
...
function getTeamList(year, pageNumber) {
    ...
    req.open('GET', apiURL + year + '/teams/' + localStorage.currentEvent + '/' + pageNumber);
    req.addEventListener('load', function () {
        var data = "";
        $('#teamloadprogress').show();
...
function announceDisplay() {
    ...
    for (var ii = 0; ii < teamCount; ii++) {
        ...
        //        //getTeamData(currentMatchData.Teams[ii].teamNumber,localStorage.currentYear);}
    ...
    req.addEventListener('load', function () {
        ...
        if (data.Rankings.length === 0) {
            ...
            for (var i = 0; i < data.Rankings.length; i++) {
                ...
                //                //getTeamData(data.Rankings[i].teamNumber,localStorage.currentYear);}
...
function generateMatchTableRow(matchData) {
    ...
    if ((matchData.scoreRedFinal !== null) && (matchData.scoreRedFinal > matchData.scoreBlueFinal)) {
        matchWinner = "Red";
        returnData += '<span class="redScoreWin">R:' + matchData.scoreRedFinal + '</span> <span class="blueScore"> B:' + matchData.scoreBlueFinal + '</span></td><td>';
    } else if ((matchData.scoreRedFinal !== null) && matchData.scoreRedFinal < matchData.scoreBlueFinal) {
        matchWinner = "Blue";
        returnData += '<span class="redScore">R:' + matchData.scoreRedFinal + '</span> <span class="blueScoreWin"> B:' + matchData.scoreBlueFinal + '</span></td><td>';
    } else if (matchData.scoreRedFinal !== null) {
        matchWinner = "Tie";
        returnData += '<span class="redScore">R:' + matchData.scoreRedFinal + '</span> <span class="blueScore"> B:' + matchData.scoreBlueFinal + '</span></td><td>';
    } else {
